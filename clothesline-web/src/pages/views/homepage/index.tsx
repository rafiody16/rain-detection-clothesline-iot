                ...
                <section className={styles.card}>
                    ...
                    <div className={styles.cardBody}>
                        ...
                        <div className={styles.weatherMain}>
                            ...
                            {precip > 0.5 ? (
                                cloudCover > 50 ? <IoIosRainy className={styles.rainIcon}/> : <SiRainyun className={styles.rainnyCloudyIcon}/>
                            ) : cloudCover > 50 ? (
                    ...
                    <div className={styles.cardFooter}>
                        {cloudCover <= 30 && precip < 0.5 ? (
                            <div className={styles.statusBannerSuccess}>✓ Kondisi sangat baik untuk menjemur pakaian.</div>       
                        ) : cloudCover > 30 && precip < 0.5 ? (
                            <div className={styles.statusBannerWarning}>⚠️ Kondisi cukup baik untuk menjemur pakaian.</div>
                        ) : (
                            <div className={styles.statusBannerError}>✗ Kondisi tidak baik untuk menjemur pakaian.</div>
                        )} 
                    </div>
                </section>
